...
export const GoogleLogo: React.FC<GoogleLogoProps> = ({ className = 'h-[22px] w-[22px] shrink-0' }) => (
  <svg
    viewBox="0 0 48 48"
  ...
  >
    ...
    <path fill="#4CAF50" d="M24 44c5.2 0 9.9-2 13.4-5.2l-6.2-5.2C29.3 35.1 26.8 36 24 36c-5.3 0-9.7-3.3-11.3-7.9l-6.5 5C9.5 39.6 16.2 44 24 44z" />
    <path fill="#1976D2" d="M43.6 20.1H42V20H24v8h11.3c-1.1 3.2-3.5 5.7-6.5 7.1l.1.1 6.2 5.2C36.3 41.3 44 36 44 24c0-1.3-.1-2.7-.4-3.9z" />
  </svg>
);
